...
IO.prototype.copy = function(output, mode, options) {
    var outStream = Cc["@mozilla.org/intl/converter-output-stream;1"]
        .createInstance(Ci.nsIConverterOutputStream);
    outStream.init(this.outputStream, null, 0, 0);
    var inStream = Cc["@mozilla.org/intl/converter-input-stream;1"]
        .createInstance(Ci.nsIConverterInputStream);
    inStream.init(this.inputStream, null, 0, 0);
    outStream.writeFrom(inStream, null);
};
