 ...
 *   Irakli Gozalishvili <rfobic@gmail.com> (v4, lib/jack/handler/mozhttpd.js)
 *
...
var DEBUG = system.debug; // non-const *only* so tweakable in server tests
...
const WritablePropertyBag = CC("@mozilla.org/hash-property-bag;1", "nsIWritablePropertyBag2");
...
function nsHttpServer() {
    if (!gThreadManager) gThreadManager = Cc["@mozilla.org/thread-manager;1"].getService();
...
// NSISERVERSOCKETLISTENER
    ...
    */
    ...
    stop: function(callback) {
        if (!callback) throw Cr.NS_ERROR_NULL_POINTER;
        if (!this._socket) throw Cr.NS_ERROR_UNEXPECTED;
...
_processBody: function()
{
    ...
    if (this._contentLength == 0)
    {
        //this._validateRequest(); jack will take care of validation
...
ServerHandler.prototype =
    ...
    */
    _handleDefault: function(metadata, response)
    {
        ...
        // path-to-directory mapping in the requested
