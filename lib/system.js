...
exports.prefixes.push(DirService.get("resource:app", Ci.nsIFile).path); // application directory
exports.prefixes.push(DirService.get("ProfD", Ci.nsIFile).path); // profile directory
