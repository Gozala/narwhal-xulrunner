...
IO.prototype.read = function(length) {
    ...
    stream.init(this,inputStream, "UTF-8", 0, 0);
    
    let (str = {}) {
      cstream.readString((length ? length : -1), str);
      data = str.value;
    }
    return data;
}
...
IO.prototype.copy = function (output, mode, options) {
    ...
    stream.init(this.output, null, 0, 0);
    var line = {},
        lines = [],
        haveMore;
    do {
...
exports.TextOutputStream = function (raw, lineBuffering, buffering, charset, options) {
    ...
    self.write = function () {
        stream.writeString(stream, arguments.join(""));
        return self;
    };
